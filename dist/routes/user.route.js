...
user_route.route('/send-otp').patch(user_controller_1.default.login_otp);
user_route.route('/validate-otp').patch(user_controller_1.default.validate_otp);
user_route.route('/generate-api-key').patch(validate_token_middlleware_1.default, user_controller_1.default.generate_api_key);
user_route.route('/view-api-key').get(validate_token_middlleware_1.default, user_controller_1.default.view_api_key);
user_route.route('/delete-api-key').delete(validate_token_middlleware_1.default, user_controller_1.default.delete_api_key);
